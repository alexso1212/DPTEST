...
export const CHARACTERS: Record<string, CharacterData> = {
  ...
  EX: { id: "EX", name: "趋势霸主", english: "THE TITAN", subtitle: "EDGE × EXEC", element: "✨", elementName: "RADIANCE",
    quote: "大势已定，我只需要上车。", storyHint: "当所有人都说趋势已经结束的时候，他选择了加仓。",
    colors: { primary: "#DAA520", secondary: "#2D1B4E", accent: "#F0C850", dark: "#140e04", glow: "rgba(218,165,32,0.4)" } },
