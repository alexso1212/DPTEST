...
2. **主页 Dashboard**: 显示测评状态、4小时倒计时解锁完整报告、官网模块入口（PropFirm汇总/知识星球/直播间/交易工具/学员案例，均跳转 deltapex.zeabur.app）
...
- `CharacterIcon.tsx` — 12个类型独立的SVG动画图标
...
│   ├── CharacterIcon.tsx # 12种类型SVG动画图标
